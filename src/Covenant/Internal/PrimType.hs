...
import Covenant.Internal.ASGNode (ASGType (TyExpr, TyLam))
...
typeOfOneArgFunc =
  ...
  where
    ...
    liftTy (t1, t2) = (TyExpr t1, TyExpr t2)
...
typeOfTwoArgFunc =
  ...
  where
    ...
    liftTy (t1, t2, t3) = (TyExpr t1, TyExpr t2, TyExpr t3)
...
typeOfThreeArgFunc =
  ...
  where
    ...
    liftTy (t1, t2, t3, t4) = (TyExpr t1, TyExpr t2, TyExpr t3, TyExpr t4)
...
typeOfSixArgFunc = \case
  ...
  CaseData ->
    ( -- Int -> [Data] -> a
      TyLam (TyExpr TyInteger) (TyLam (TyExpr (TyList TyPlutusData)) (TyExpr TyUnit)),
      -- (Data, Data) -> a
      TyLam (TyExpr (TyPair TyPlutusData TyPlutusData)) (TyExpr TyUnit),
      -- [Data] -> a
      TyLam (TyExpr (TyList TyPlutusData)) (TyExpr TyUnit),
      -- Data -> a
      TyLam (TyExpr TyPlutusData) (TyExpr TyUnit),
      -- Int -> a
      TyLam (TyExpr TyInteger) (TyExpr TyUnit),
      -- ByteString -> a
      TyLam (TyExpr TyByteString) (TyExpr TyUnit),
      -- a
      TyExpr TyUnit
    )
